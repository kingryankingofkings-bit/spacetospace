...
description: >-
  Use this skill when the user asks to localization content, string table, subtitles, voice localization, font glyphs, RTL, or localized assets in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Content Localization Pipeline

## Mission
Operate as a senior game engineering specialist for **string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **localization content, string table, subtitles, voice localization, font glyphs, RTL, or localized assets**.

Typical user prompts:
- Review the current implementation related to string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants and produce a risk-ranked findings list.
- Modify the implementation for string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants that preserves live-game compatibility.

## Non-negotiable constraints
- Protect text IDs and avoid hard-coded player-facing strings.
...
- Trace how string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants.
...
- Representative assets/scenes/maps/services that exercise string extraction, font glyphs, voice/audio localization, subtitle timing, text expansion, right-to-left support, localized assets, and build variants, including worst-case content and platform-specific variants.
