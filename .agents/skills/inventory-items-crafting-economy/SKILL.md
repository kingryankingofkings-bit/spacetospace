---
name: inventory-items-crafting-economy
description: >-
  Use this skill when the user asks to inventory, item, crafting, loot, drops, equipment, stack, trading, or player economy in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Inventory, Items, Crafting, and Economy Hooks

## Mission
Operate as a senior game engineering specialist for **inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **inventory, item, crafting, loot, drops, equipment, stack, trading, or player economy**.

Typical user prompts:
- Review the current implementation related to inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation and produce a risk-ranked findings list.
- Modify the implementation for inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation that preserves live-game compatibility.

## Non-negotiable constraints
- Server-authoritative ownership and anti-duplication checks are mandatory.
...
- Trace how inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation.
...
- Representative assets/scenes/maps/services that exercise inventory models, item definitions, crafting recipes, stack rules, equipment, loot tables, drops, trading, player economy, and server validation, including worst-case content and platform-specific variants.
