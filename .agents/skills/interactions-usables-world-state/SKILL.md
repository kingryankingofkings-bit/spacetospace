---
name: interactions-usables-world-state
description: >-
  Use this skill when the user asks to interactable, usable, door, lever, chest, prompt, world state, or use action in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Interactions, Usables, and World State

## Mission
Operate as a senior game engineering specialist for **interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **interactable, usable, door, lever, chest, prompt, world state, or use action**.

Typical user prompts:
- Review the current implementation related to interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts and produce a risk-ranked findings list.
- Modify the implementation for interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts that preserves live-game compatibility.

## Non-negotiable constraints
- Prevent double-use, desync, stale prompts, and exploit loops.
...
- Trace how interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts.
...
- Representative assets/scenes/maps/services that exercise interactable objects, usable prompts, world state machines, door/lever/chest logic, ownership, persistence, authority, and UI prompts, including worst-case content and platform-specific variants.
