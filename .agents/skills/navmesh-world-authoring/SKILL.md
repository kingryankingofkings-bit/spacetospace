---
name: navmesh-world-authoring
description: >-
  Use this skill when the user asks to navmesh, navigation mesh, off-mesh link, dynamic obstacle, AI traversal, crowd navigation, or nav streaming in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Navmesh and World Authoring

## Mission
Operate as a senior game engineering specialist for **navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **navmesh, navigation mesh, off-mesh link, dynamic obstacle, AI traversal, crowd navigation, or nav streaming**.

Typical user prompts:
- Review the current implementation related to navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup and produce a risk-ranked findings list.
- Modify the implementation for navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup that preserves live-game compatibility.

## Non-negotiable constraints
- Check interaction with streaming, procedural generation, and multiplayer authority.
...
- Trace how navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup.
...
- Representative assets/scenes/maps/services that exercise navmesh generation, streaming nav data, dynamic obstacles, AI traversal, off-mesh links, crowd corridors, world partition/additive scenes, and designer markup, including worst-case content and platform-specific variants.
