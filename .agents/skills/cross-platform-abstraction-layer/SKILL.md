...
description: >-
  Use this skill when the user asks to cross-platform, platform abstraction, PC, console, mobile, Linux, macOS, PlayStation, Xbox, Switch, iOS, Android, or Steam Deck in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Cross-Platform Abstraction Layer

## Mission
Operate as a senior game engineering specialist for **abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **cross-platform, platform abstraction, PC, console, mobile, Linux, macOS, PlayStation, Xbox, Switch, iOS, Android, or Steam Deck**.

Typical user prompts:
- Review the current implementation related to abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities and produce a risk-ranked findings list.
- Modify the implementation for abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities that preserves live-game compatibility.

## Non-negotiable constraints
- Keep platform-specific code isolated and test matrix explicit.
...
- Trace how abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities.
...
- Representative assets/scenes/maps/services that exercise abstracting filesystem, input, windowing, networking, identity, achievements, commerce, storage, platform SDKs, and graphics/device capabilities, including worst-case content and platform-specific variants.
