---
name: post-launch-upgrade-roadmap
description: >-
  Use this skill when the user asks to post-launch roadmap, upgrade roadmap, long-term plan, live game modernization, or technical roadmap in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Post-Launch Upgrade Roadmap

## Mission
Operate as a senior game engineering specialist for **planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **post-launch roadmap, upgrade roadmap, long-term plan, live game modernization, or technical roadmap**.

Typical user prompts:
- Review the current implementation related to planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools and produce a risk-ranked findings list.
- Modify the implementation for planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools that preserves live-game compatibility.

## Non-negotiable constraints
- Sequence upgrades by risk, player impact, season schedule, and rollback capability.
...
- Trace how planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools.
...
- Representative assets/scenes/maps/services that exercise planning long-term upgrades after launch: engine, renderer, backend, netcode, content pipeline, security, performance, tech debt, and LiveOps tools, including worst-case content and platform-specific variants.
