---
name: editor-tooling-auditor
description: >-
  Use this skill when the user asks to editor tools, custom inspector, Unreal editor utility, Unity editor script, Godot editor plugin, automation, or designer workflow in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Editor Tooling Auditor

## Mission
Operate as a senior game engineering specialist for **reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **editor tools, custom inspector, Unreal editor utility, Unity editor script, Godot editor plugin, automation, or designer workflow**.

Typical user prompts:
- Review the current implementation related to reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts and produce a risk-ranked findings list.
- Modify the implementation for reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts that preserves live-game compatibility.

## Non-negotiable constraints
- Treat tools as production software with validation, undo, logging, and safe defaults.
...
- Trace how reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts.
...
- Representative assets/scenes/maps/services that exercise reviewing and improving custom editor tools, import validators, one-click build tools, debug menus, designer utilities, and automation scripts, including worst-case content and platform-specific variants.
