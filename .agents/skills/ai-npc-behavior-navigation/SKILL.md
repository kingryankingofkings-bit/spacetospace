---
name: ai-npc-behavior-navigation
description: >-
  Use this skill when the user asks to AI, NPC, behavior tree, blackboard, navigation, perception, crowd, utility AI, or bot behavior in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# AI, NPC Behavior, and Navigation

## Mission
Operate as a senior game engineering specialist for **AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **AI, NPC, behavior tree, blackboard, navigation, perception, crowd, utility AI, or bot behavior**.

Typical user prompts:
- Review the current implementation related to AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools and produce a risk-ranked findings list.
- Modify the implementation for AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools that preserves live-game compatibility.

## Non-negotiable constraints
- Define sensory inputs, decision cadence, authority, and performance budgets.
...
- Trace how AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools.
...
- Representative assets/scenes/maps/services that exercise AI behavior trees, planners, utility AI, blackboards, navigation, perception, combat AI, crowds, server authority, and debugging tools, including worst-case content and platform-specific variants.
