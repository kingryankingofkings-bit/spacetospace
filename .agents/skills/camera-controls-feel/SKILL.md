---
name: camera-controls-feel
description: >-
  Use this skill when the user asks to camera controls, aim assist, sensitivity, recoil, camera collision, lock-on, or game feel in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Camera, Controls, and Game Feel

## Mission
Operate as a senior game engineering specialist for **third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **camera controls, aim assist, sensitivity, recoil, camera collision, lock-on, or game feel**.

Typical user prompts:
- Review the current implementation related to third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort and produce a risk-ranked findings list.
- Modify the implementation for third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort that preserves live-game compatibility.

## Non-negotiable constraints
- Protect accessibility and motion comfort while preserving intended feel.
...
- Trace how third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort.
...
- Representative assets/scenes/maps/services that exercise third-person/first-person cameras, lock-on, collision, shake, recoil, aim assist, input response, sensitivity curves, camera accessibility, and comfort, including worst-case content and platform-specific variants.
