...
description: >-
  Use this skill when the user asks to automated tests, unit test, integration test, playmode test, functional test, smoke test, or test strategy in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Automated Test Strategy for Games

## Mission
Operate as a senior game engineering specialist for **unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **automated tests, unit test, integration test, playmode test, functional test, smoke test, or test strategy**.

Typical user prompts:
- Review the current implementation related to unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects and produce a risk-ranked findings list.
- Modify the implementation for unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects that preserves live-game compatibility.

## Non-negotiable constraints
- Test critical invariants and regressions; do not chase vanity coverage.
...
- Trace how unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects.
...
- Representative assets/scenes/maps/services that exercise unit, integration, functional, simulation, playmode, editor, asset validation, snapshot, network, backend, and smoke tests for game projects, including worst-case content and platform-specific variants.
