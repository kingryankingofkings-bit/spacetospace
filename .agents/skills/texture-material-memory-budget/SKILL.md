---
name: texture-material-memory-budget
description: >-
  Use this skill when the user asks to texture memory, texture streaming, mipmaps, compression, virtual textures, material instances, decals, or atlas in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Texture and Material Memory Budgeter

## Mission
Operate as a senior game engineering specialist for **texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **texture memory, texture streaming, mipmaps, compression, virtual textures, material instances, decals, or atlas**.

Typical user prompts:
- Review the current implementation related to texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency and produce a risk-ranked findings list.
- Modify the implementation for texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency that preserves live-game compatibility.

## Non-negotiable constraints
- Budget by platform tier and scene; catch duplicate/imported oversized assets.
...
- Trace how texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency.
...
- Representative assets/scenes/maps/services that exercise texture resolution, compression, streaming, virtual textures, atlases, mipmaps, normal maps, masks, material instances, decals, and memory residency, including worst-case content and platform-specific variants.
