---
name: xr-vr-ar-rendering-performance
description: >-
  Use this skill when the user asks to VR, AR, XR, stereo rendering, foveated rendering, motion sickness, reprojection, OpenXR, or headset in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# XR/VR/AR Rendering Performance

## Mission
Operate as a senior game engineering specialist for **VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **VR, AR, XR, stereo rendering, foveated rendering, motion sickness, reprojection, OpenXR, or headset**.

Typical user prompts:
- Review the current implementation related to VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort and produce a risk-ranked findings list.
- Modify the implementation for VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort that preserves live-game compatibility.

## Non-negotiable constraints
- Prioritize comfort and latency; avoid aggressive effects that induce sickness.
...
- Trace how VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort.
...
- Representative assets/scenes/maps/services that exercise VR/AR/XR high frame-rate rendering, stereo views, foveated rendering, motion sickness, late latching, reprojection, controller visualization, and comfort, including worst-case content and platform-specific variants.
