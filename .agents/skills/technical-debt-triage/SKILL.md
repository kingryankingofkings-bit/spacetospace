...
description: >-
  Use this skill when the user asks to prioritize debt, clean up, decide what to fix first, or create a technical debt roadmap for a game project in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Technical Debt Triage for Game Teams

## Mission
Operate as a senior game engineering specialist for **sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **prioritize debt, clean up, decide what to fix first, or create a technical debt roadmap for a game project**.

Typical user prompts:
- Review the current implementation related to sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers and produce a risk-ranked findings list.
- Modify the implementation for sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers that preserves live-game compatibility.

## Non-negotiable constraints
- Separate cosmetic cleanup from release blockers and compounding architectural debt.
...
- Trace how sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers.
...
- Representative assets/scenes/maps/services that exercise sorting technical debt by player impact, delivery risk, performance cost, complexity, exploitability, and upgrade blockers, including worst-case content and platform-specific variants.
