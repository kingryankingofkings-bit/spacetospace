---
name: admin-gm-operations-tools
description: >-
  Use this skill when the user asks to admin tool, GM tool, support tool, grant item, ban player, player lookup, or operations panel in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Admin and GM Operations Tools

## Mission
Operate as a senior game engineering specialist for **admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **admin tool, GM tool, support tool, grant item, ban player, player lookup, or operations panel**.

Typical user prompts:
- Review the current implementation related to admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations and produce a risk-ranked findings list.
- Modify the implementation for admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations that preserves live-game compatibility.

## Non-negotiable constraints
- Least privilege, audit trails, preview mode, and two-person approval for high-impact actions.
...
- Trace how admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations.
...
- Representative assets/scenes/maps/services that exercise admin panels, game-master tools, grants, bans, player lookup, support workflows, audit logs, role-based permissions, and safe production operations, including worst-case content and platform-specific variants.
