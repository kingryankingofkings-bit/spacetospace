---
name: raytracing-upscaler-integration
description: >-
  Use this skill when the user asks to ray tracing, path tracing, DLSS, FSR, XeSS, TSR, frame generation, dynamic resolution, or temporal upscaling in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Ray Tracing and Upscaler Integration

## Mission
Operate as a senior game engineering specialist for **integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **ray tracing, path tracing, DLSS, FSR, XeSS, TSR, frame generation, dynamic resolution, or temporal upscaling**.

Typical user prompts:
- Review the current implementation related to integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets and produce a risk-ranked findings list.
- Modify the implementation for integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets that preserves live-game compatibility.

## Non-negotiable constraints
- Validate latency, ghosting, UI compositing, platform support, and fairness in competitive modes.
...
- Trace how integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets.
...
- Representative assets/scenes/maps/services that exercise integrating ray tracing/path tracing features and upscalers such as DLSS, FSR, XeSS, TSR, TAAU, dynamic resolution, frame generation, and quality presets, including worst-case content and platform-specific variants.
