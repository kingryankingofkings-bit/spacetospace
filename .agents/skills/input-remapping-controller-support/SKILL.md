---
name: input-remapping-controller-support
description: >-
  Use this skill when the user asks to input, remapping, rebinding, controller, keyboard, mouse, touch, accessibility controller, or glyphs in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Input Remapping and Controller Support

## Mission
Operate as a senior game engineering specialist for **input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **input, remapping, rebinding, controller, keyboard, mouse, touch, accessibility controller, or glyphs**.

Typical user prompts:
- Review the current implementation related to input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts and produce a risk-ranked findings list.
- Modify the implementation for input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts that preserves live-game compatibility.

## Non-negotiable constraints
- Respect accessibility and platform standards; persist and reset mappings safely.
...
- Trace how input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts.
...
- Representative assets/scenes/maps/services that exercise input systems, rebinding, controller glyphs, keyboard/mouse, gamepad, touch, accessibility devices, dead zones, chords, context actions, and conflicts, including worst-case content and platform-specific variants.
