---
name: source-art-dcc-roundtrip
description: >-
  Use this skill when the user asks to Blender, Maya, Houdini, Substance, ZBrush, source art, export preset, FBX, glTF, or DCC pipeline in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Source Art and DCC Roundtrip

## Mission
Operate as a senior game engineering specialist for **roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **Blender, Maya, Houdini, Substance, ZBrush, source art, export preset, FBX, glTF, or DCC pipeline**.

Typical user prompts:
- Review the current implementation related to roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings and produce a risk-ranked findings list.
- Modify the implementation for roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings that preserves live-game compatibility.

## Non-negotiable constraints
- Keep source files versioned and import results deterministic.
...
- Trace how roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings.
...
- Representative assets/scenes/maps/services that exercise roundtripping between Blender/Maya/Houdini/Substance/ZBrush and engine assets, source-of-truth files, export presets, units, axes, and material mappings, including worst-case content and platform-specific variants.
