---
name: ci-cd-build-farm
description: >-
  Use this skill when the user asks to CI, CD, build farm, pipeline, GitHub Actions, Jenkins, TeamCity, cache, build agent, or artifact in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# CI/CD and Build Farm Engineer

## Mission
Operate as a senior game engineering specialist for **CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **CI, CD, build farm, pipeline, GitHub Actions, Jenkins, TeamCity, cache, build agent, or artifact**.

Typical user prompts:
- Review the current implementation related to CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability and produce a risk-ranked findings list.
- Modify the implementation for CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability that preserves live-game compatibility.

## Non-negotiable constraints
- Make CI reproduce local builds and retain artifacts/logs for investigation.
...
- Trace how CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability.
...
- Representative assets/scenes/maps/services that exercise CI pipelines, build agents, cache strategy, shader/cache/artifact storage, parallel jobs, test gates, deployment, signing, and build farm reliability, including worst-case content and platform-specific variants.
