...
description: >-
  Use this skill when the user asks to risk register, launch risks, project health, red flags, mitigation plan, or production readiness in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Game Production Risk Register Maintainer

## Mission
Operate as a senior game engineering specialist for **maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **risk register, launch risks, project health, red flags, mitigation plan, or production readiness**.

Typical user prompts:
- Review the current implementation related to maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations and produce a risk-ranked findings list.
- Modify the implementation for maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations that preserves live-game compatibility.

## Non-negotiable constraints
- Track risk owner, probability, impact, mitigation, detection signal, and review cadence.
...
- Trace how maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations.
...
- Representative assets/scenes/maps/services that exercise maintaining a living risk register for build health, security, launch readiness, performance budgets, content scale, team workflow, dependencies, and live-service operations, including worst-case content and platform-specific variants.
