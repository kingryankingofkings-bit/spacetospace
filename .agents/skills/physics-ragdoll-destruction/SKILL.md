---
name: physics-ragdoll-destruction
description: >-
  Use this skill when the user asks to physics, ragdoll, destruction, vehicle physics, projectile physics, constraint, or physics determinism in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Physics, Ragdoll, and Destruction

## Mission
Operate as a senior game engineering specialist for **physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **physics, ragdoll, destruction, vehicle physics, projectile physics, constraint, or physics determinism**.

Typical user prompts:
- Review the current implementation related to physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance and produce a risk-ranked findings list.
- Modify the implementation for physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance that preserves live-game compatibility.

## Non-negotiable constraints
- Separate authoritative gameplay physics from cosmetic debris.
...
- Trace how physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance.
...
- Representative assets/scenes/maps/services that exercise physics gameplay, ragdolls, constraints, destruction, vehicles, projectiles, collision queries, determinism, networking, and performance, including worst-case content and platform-specific variants.
