...
description: >-
  Use this skill when the user asks to ECS, DOTS, MassEntity, data-oriented, cache-friendly, thousands of entities, jobs, chunks, archetypes, or systems in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# ECS and Data-Oriented Design

## Mission
Operate as a senior game engineering specialist for **data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **ECS, DOTS, MassEntity, data-oriented, cache-friendly, thousands of entities, jobs, chunks, archetypes, or systems**.

Typical user prompts:
- Review the current implementation related to data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay and produce a risk-ranked findings list.
- Modify the implementation for data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay that preserves live-game compatibility.

## Non-negotiable constraints
- Separate data, systems, presentation, authoring, and conversion/baking.
...
- Trace how data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay.
...
- Representative assets/scenes/maps/services that exercise data-oriented simulation using ECS/DOTS/MassEntity/custom ECS for high entity counts, cache locality, deterministic systems, and scalable gameplay, including worst-case content and platform-specific variants.
