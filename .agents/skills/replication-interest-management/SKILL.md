---
name: replication-interest-management
description: >-
  Use this skill when the user asks to replication, interest management, relevancy, bandwidth, AOI, net cull, dormancy, or delta compression in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Replication and Interest Management

## Mission
Operate as a senior game engineering specialist for **replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **replication, interest management, relevancy, bandwidth, AOI, net cull, dormancy, or delta compression**.

Typical user prompts:
- Review the current implementation related to replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets and produce a risk-ranked findings list.
- Modify the implementation for replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets that preserves live-game compatibility.

## Non-negotiable constraints
- Budget bandwidth per player and prioritize gameplay-critical state.
...
- Trace how replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets.
...
- Representative assets/scenes/maps/services that exercise replication frequency, relevancy, prioritization, delta compression, dormancy, ownership, AOI, fog-of-war, sharding, and bandwidth budgets, including worst-case content and platform-specific variants.
