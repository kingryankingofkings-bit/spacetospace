---
name: cloud-saves-cross-progression
description: >-
  Use this skill when the user asks to cloud save, cross-progression, save conflict, offline progress, platform sync, or account merge in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Cloud Saves and Cross-Progression

## Mission
Operate as a senior game engineering specialist for **cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **cloud save, cross-progression, save conflict, offline progress, platform sync, or account merge**.

Typical user prompts:
- Review the current implementation related to cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery and produce a risk-ranked findings list.
- Modify the implementation for cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery that preserves live-game compatibility.

## Non-negotiable constraints
- Never overwrite progress without conflict policy and backup.
...
- Trace how cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery.
...
- Representative assets/scenes/maps/services that exercise cloud saves, cross-progression, conflict resolution, offline changes, multiple platforms, entitlement merges, and data recovery, including worst-case content and platform-specific variants.
