---
name: economy-balancing-fraud
description: >-
  Use this skill when the user asks to economy, currency, fraud, duping, reward exploit, marketplace, sink, source, or inflation in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Economy Balancing and Fraud Controls

## Mission
Operate as a senior game engineering specialist for **virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **economy, currency, fraud, duping, reward exploit, marketplace, sink, source, or inflation**.

Typical user prompts:
- Review the current implementation related to virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards and produce a risk-ranked findings list.
- Modify the implementation for virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards that preserves live-game compatibility.

## Non-negotiable constraints
- Critical economy writes belong on trusted services with audit trails.
...
- Trace how virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards.
...
- Representative assets/scenes/maps/services that exercise virtual economy tuning, currencies, sinks/sources, fraud detection, dupe prevention, reward integrity, market exploits, and anomaly dashboards, including worst-case content and platform-specific variants.
