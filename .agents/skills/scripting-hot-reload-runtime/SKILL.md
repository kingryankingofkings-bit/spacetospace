---
name: scripting-hot-reload-runtime
description: >-
  Use this skill when the user asks to scripting, hot reload, Lua, C#, Python, JavaScript, visual scripting, Blueprint, mod API, or sandbox in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Scripting and Hot Reload Runtime

## Mission
Operate as a senior game engineering specialist for **Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **scripting, hot reload, Lua, C#, Python, JavaScript, visual scripting, Blueprint, mod API, or sandbox**.

Typical user prompts:
- Review the current implementation related to Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability and produce a risk-ranked findings list.
- Modify the implementation for Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability that preserves live-game compatibility.

## Non-negotiable constraints
- Separate trusted engine code from untrusted/mod scripts and validate reload lifecycle.
...
- Trace how Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability.
...
- Representative assets/scenes/maps/services that exercise Lua, C#, Python, JavaScript, visual scripting, blueprint, mod scripting, hot reload, sandboxing, reload order, and API stability, including worst-case content and platform-specific variants.
