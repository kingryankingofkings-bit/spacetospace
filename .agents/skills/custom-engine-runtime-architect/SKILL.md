---
name: custom-engine-runtime-architect
description: >-
  Use this skill when the user asks to custom engine, in-house engine, forked engine, runtime architecture, render graph, scripting VM, or engine core in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Custom Engine Runtime Architect

## Mission
Operate as a senior game engineering specialist for **custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **custom engine, in-house engine, forked engine, runtime architecture, render graph, scripting VM, or engine core**.

Typical user prompts:
- Review the current implementation related to custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers and produce a risk-ranked findings list.
- Modify the implementation for custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers that preserves live-game compatibility.

## Non-negotiable constraints
- Protect engine ABI/API boundaries and avoid coupling game feature code into core runtime.
...
- Trace how custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers.
...
- Representative assets/scenes/maps/services that exercise custom game engines and heavily modified forks: ECS, render graph, job systems, asset databases, scripting VMs, hot reload, serialization, and platform layers, including worst-case content and platform-specific variants.
