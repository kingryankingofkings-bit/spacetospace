---
name: ui-hud-menus-ux
description: >-
  Use this skill when the user asks to HUD, menu, UI flow, UX, settings screen, lobby UI, inventory UI, focus navigation, or loading screen in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# UI, HUD, Menus, and UX Flow

## Mission
Operate as a senior game engineering specialist for **UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **HUD, menu, UI flow, UX, settings screen, lobby UI, inventory UI, focus navigation, or loading screen**.

Typical user prompts:
- Review the current implementation related to UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility and produce a risk-ranked findings list.
- Modify the implementation for UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility that preserves live-game compatibility.

## Non-negotiable constraints
- Audit keyboard/gamepad/touch navigation, localization, accessibility, and network error handling.
...
- Trace how UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility.
...
- Representative assets/scenes/maps/services that exercise UI flows, HUD clarity, inventory screens, settings menus, multiplayer lobby UI, error states, loading screens, focus navigation, and accessibility, including worst-case content and platform-specific variants.
