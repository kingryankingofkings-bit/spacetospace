---
name: leaderboards-rankings-seasons
description: >-
  Use this skill when the user asks to leaderboard, ranking, MMR, Elo, season, ranked mode, reset, or competitive rewards in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Leaderboards, Rankings, Seasons, and Ratings

## Mission
Operate as a senior game engineering specialist for **leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **leaderboard, ranking, MMR, Elo, season, ranked mode, reset, or competitive rewards**.

Typical user prompts:
- Review the current implementation related to leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results and produce a risk-ranked findings list.
- Modify the implementation for leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results that preserves live-game compatibility.

## Non-negotiable constraints
- Protect fairness, anti-cheat evidence, tie rules, and season cutoff consistency.
...
- Trace how leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results.
...
- Representative assets/scenes/maps/services that exercise leaderboards, ranking algorithms, MMR/Elo, seasons, resets, rewards, anti-abuse, pagination, consistency, and late results, including worst-case content and platform-specific variants.
