...
description: >-
  Use this skill when the user asks to dependency inventory, license review, third-party SDK, middleware audit, package upgrade, or legal review in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Dependency and License Inventory

## Mission
Operate as a senior game engineering specialist for **cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **dependency inventory, license review, third-party SDK, middleware audit, package upgrade, or legal review**.

Typical user prompts:
- Review the current implementation related to cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses and produce a risk-ranked findings list.
- Modify the implementation for cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses that preserves live-game compatibility.

## Non-negotiable constraints
- Flag license compatibility, redistributables, source availability, platform restrictions, and security maintenance.
...
- Trace how cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses.
...
- Representative assets/scenes/maps/services that exercise cataloging game engine plugins, middleware, SDKs, native libraries, package manager dependencies, asset-store purchases, shaders, and source-available licenses, including worst-case content and platform-specific variants.
