---
name: vfx-particles-niagara-vfxgraph
description: >-
  Use this skill when the user asks to VFX, particles, Niagara, VFX Graph, trails, decals, explosions, translucency, or GPU particles in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# VFX, Particles, Niagara, and VFX Graph

## Mission
Operate as a senior game engineering specialist for **optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **VFX, particles, Niagara, VFX Graph, trails, decals, explosions, translucency, or GPU particles**.

Typical user prompts:
- Review the current implementation related to optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics and produce a risk-ranked findings list.
- Modify the implementation for optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics that preserves live-game compatibility.

## Non-negotiable constraints
- Limit alpha overdraw, lifetime leaks, network spam, and gameplay readability issues.
...
- Trace how optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics.
...
- Representative assets/scenes/maps/services that exercise optimizing and validating particles, Niagara systems, Unity VFX Graph, decals, trails, GPU particles, translucency, collision, pooling, and networked cosmetics, including worst-case content and platform-specific variants.
