---
name: plugin-middleware-integration
description: >-
  Use this skill when the user asks to middleware, SDK, plugin, third-party integration, Wwise, FMOD, Havok, PhysX, EOS, Steamworks, Vivox, or telemetry SDK in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Plugin and Middleware Integration

## Mission
Operate as a senior game engineering specialist for **integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **middleware, SDK, plugin, third-party integration, Wwise, FMOD, Havok, PhysX, EOS, Steamworks, Vivox, or telemetry SDK**.

Typical user prompts:
- Review the current implementation related to integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems and produce a risk-ranked findings list.
- Modify the implementation for integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems that preserves live-game compatibility.

## Non-negotiable constraints
- Wrap SDKs behind adapters; isolate secrets; handle platform-specific compile/runtime behavior.
...
- Trace how integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems.
...
- Representative assets/scenes/maps/services that exercise integrating and upgrading middleware for physics, audio, networking, anti-cheat, analytics, console SDKs, platform services, ads, crash reporting, and payment systems, including worst-case content and platform-specific variants.
