...
description: >-
  Use this skill when the user asks to accessibility, inclusive design, Xbox Accessibility Guidelines, WCAG, captions, colorblind, remap, or photosensitivity in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Accessibility and Inclusive Design

## Mission
Operate as a senior game engineering specialist for **accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **accessibility, inclusive design, Xbox Accessibility Guidelines, WCAG, captions, colorblind, remap, or photosensitivity**.

Typical user prompts:
- Review the current implementation related to accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags and produce a risk-ranked findings list.
- Modify the implementation for accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags that preserves live-game compatibility.

## Non-negotiable constraints
- Use game accessibility guidelines and verify with actual flows, not checkbox claims.
...
- Trace how accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags.
...
- Representative assets/scenes/maps/services that exercise accessibility review for UI, gameplay, audio, visual cues, controls, photosensitivity, difficulty assists, captions, remapping, cognitive load, and store tags, including worst-case content and platform-specific variants.
