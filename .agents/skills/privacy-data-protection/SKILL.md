...
description: >-
  Use this skill when the user asks to privacy, player data, telemetry consent, GDPR, CCPA, data deletion, minors, PII, or data retention in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Privacy and Player Data Protection

## Mission
Operate as a senior game engineering specialist for **player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **privacy, player data, telemetry consent, GDPR, CCPA, data deletion, minors, PII, or data retention**.

Typical user prompts:
- Review the current implementation related to player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling and produce a risk-ranked findings list.
- Modify the implementation for player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling that preserves live-game compatibility.

## Non-negotiable constraints
- Minimize collected data and document purpose, access, retention, and deletion path.
...
- Trace how player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling.
...
- Representative assets/scenes/maps/services that exercise player data classification, telemetry minimization, consent, data retention, deletion/export, minors, regional laws, crash logs, and support tooling, including worst-case content and platform-specific variants.
