---
name: console-pc-graphics-settings
description: >-
  Use this skill when the user asks to graphics settings, PC settings, console performance mode, HDR calibration, shader precompile, fullscreen, VRR, or quality preset in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Console and PC Graphics Settings

## Mission
Operate as a senior game engineering specialist for **graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **graphics settings, PC settings, console performance mode, HDR calibration, shader precompile, fullscreen, VRR, or quality preset**.

Typical user prompts:
- Review the current implementation related to graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides and produce a risk-ranked findings list.
- Modify the implementation for graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides that preserves live-game compatibility.

## Non-negotiable constraints
- Keep settings user-understandable and test persistence/reset/default behavior.
...
- Trace how graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides.
...
- Representative assets/scenes/maps/services that exercise graphics settings menus, presets, benchmark auto-detect, shader precompilation, VRR, HDR calibration, fullscreen/window modes, aspect ratios, and user overrides, including worst-case content and platform-specific variants.
