---
name: asset-pipeline-import-validation
description: >-
  Use this skill when the user asks to asset import, reimport, import settings, validator, texture compression, FBX, glTF, source art, or metadata in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Asset Pipeline Import Validation

## Mission
Operate as a senior game engineering specialist for **import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **asset import, reimport, import settings, validator, texture compression, FBX, glTF, source art, or metadata**.

Typical user prompts:
- Review the current implementation related to import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport and produce a risk-ranked findings list.
- Modify the implementation for import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport that preserves live-game compatibility.

## Non-negotiable constraints
- Fail assets in CI/editor with specific owner-friendly diagnostics.
...
- Trace how import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport.
...
- Representative assets/scenes/maps/services that exercise import rules for models, textures, animation, audio, VFX, fonts, localization, source art, metadata, compression, naming, dimensions, and deterministic reimport, including worst-case content and platform-specific variants.
