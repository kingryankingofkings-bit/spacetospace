---
name: audio-spatial-music-mix
description: >-
  Use this skill when the user asks to audio, spatial audio, Wwise, FMOD, music, mix, occlusion, sound cue, voice line, or captions in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Audio, Spatial Sound, and Music Mix

## Mission
Operate as a senior game engineering specialist for **gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **audio, spatial audio, Wwise, FMOD, music, mix, occlusion, sound cue, voice line, or captions**.

Typical user prompts:
- Review the current implementation related to gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events and produce a risk-ranked findings list.
- Modify the implementation for gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events that preserves live-game compatibility.

## Non-negotiable constraints
- Preserve gameplay readability and localization/subtitle correctness.
...
- Trace how gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events.
...
- Representative assets/scenes/maps/services that exercise gameplay audio triggers, spatialization, occlusion, mix states, dynamic music, voice lines, UI audio, accessibility captions, and middleware events, including worst-case content and platform-specific variants.
