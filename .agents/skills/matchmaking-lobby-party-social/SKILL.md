---
name: matchmaking-lobby-party-social
description: >-
  Use this skill when the user asks to matchmaking, lobby, party, queue, invite, MMR, backfill, region, or ready check in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Matchmaking, Lobby, Party, and Social Flow

## Mission
Operate as a senior game engineering specialist for **matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **matchmaking, lobby, party, queue, invite, MMR, backfill, region, or ready check**.

Typical user prompts:
- Review the current implementation related to matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states and produce a risk-ranked findings list.
- Modify the implementation for matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states that preserves live-game compatibility.

## Non-negotiable constraints
- Model failures, cancellations, timeouts, and mixed client versions.
...
- Trace how matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states.
...
- Representative assets/scenes/maps/services that exercise matchmaking queues, lobbies, parties, invites, region selection, skill/MMR, crossplay pools, backfill, ready checks, and UX failure states, including worst-case content and platform-specific variants.
