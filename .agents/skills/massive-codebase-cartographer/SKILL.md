---
name: massive-codebase-cartographer
description: >-
  Use this skill when the user asks to understand, review, document, onboard, map, inspect architecture, find entry points, or analyze a massive game codebase in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Massive Codebase Cartographer

## Mission
Operate as a senior game engineering specialist for **mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **understand, review, document, onboard, map, inspect architecture, find entry points, or analyze a massive game codebase**.

Typical user prompts:
- Review the current implementation related to mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions and produce a risk-ranked findings list.
- Modify the implementation for mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions that preserves live-game compatibility.

## Non-negotiable constraints
- Produce system maps instead of editing too soon.
...
- Trace how mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions.
...
- Representative assets/scenes/maps/services that exercise mapping unfamiliar monorepos and hybrid repositories that contain engine code, game code, tools, content, build scripts, services, generated files, and proprietary conventions, including worst-case content and platform-specific variants.
