---
name: real-time-messaging-presence
description: >-
  Use this skill when the user asks to presence, real-time messaging, pubsub, notifications, read receipts, or player status in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Real-Time Messaging and Presence

## Mission
Operate as a senior game engineering specialist for **presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **presence, real-time messaging, pubsub, notifications, read receipts, or player status**.

Typical user prompts:
- Review the current implementation related to presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions and produce a risk-ranked findings list.
- Modify the implementation for presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions that preserves live-game compatibility.

## Non-negotiable constraints
- Bound fanout and model offline/away/invisible/privacy states.
...
- Trace how presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions.
...
- Representative assets/scenes/maps/services that exercise presence, notifications, friends status, party status, chat delivery, pub/sub, fanout, read receipts, rate limits, and mobile push interactions, including worst-case content and platform-specific variants.
