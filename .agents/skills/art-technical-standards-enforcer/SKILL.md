---
name: art-technical-standards-enforcer
description: >-
  Use this skill when the user asks to technical art standards, art validation, naming convention, pivot, scale, UV, collision, skeleton, LOD, or asset budget in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Technical Art Standards Enforcer

## Mission
Operate as a senior game engineering specialist for **technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **technical art standards, art validation, naming convention, pivot, scale, UV, collision, skeleton, LOD, or asset budget**.

Typical user prompts:
- Review the current implementation related to technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings and produce a risk-ranked findings list.
- Modify the implementation for technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings that preserves live-game compatibility.

## Non-negotiable constraints
- Make standards machine-checkable where possible.
...
- Trace how technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings.
...
- Representative assets/scenes/maps/services that exercise technical art guidelines for naming, pivots, scales, UVs, collision, materials, skeletons, LODs, textures, source files, and engine import settings, including worst-case content and platform-specific variants.
