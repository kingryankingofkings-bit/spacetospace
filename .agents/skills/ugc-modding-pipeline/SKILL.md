---
name: ugc-modding-pipeline
description: >-
  Use this skill when the user asks to modding, UGC, workshop, custom maps, user content, mod API, sandbox, or content moderation in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# UGC and Modding Pipeline

## Mission
Operate as a senior game engineering specialist for **user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **modding, UGC, workshop, custom maps, user content, mod API, sandbox, or content moderation**.

Typical user prompts:
- Review the current implementation related to user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading and produce a risk-ranked findings list.
- Modify the implementation for user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading that preserves live-game compatibility.

## Non-negotiable constraints
- Treat mod content as untrusted and isolate scripts/data.
...
- Trace how user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading.
...
- Representative assets/scenes/maps/services that exercise user-generated content, mods, workshop integration, sandboxing, content validation, dependency manifests, moderation, compatibility, and safe runtime loading, including worst-case content and platform-specific variants.
