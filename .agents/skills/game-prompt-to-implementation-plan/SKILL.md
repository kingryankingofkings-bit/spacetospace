---
name: game-prompt-to-implementation-plan
description: >-
  Use this skill when the user asks to turn this idea into a plan, write implementation plan, scope feature, break down work, or create tasks in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Game Prompt to Implementation Plan

## Mission
Operate as a senior game engineering specialist for **turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **turn this idea into a plan, write implementation plan, scope feature, break down work, or create tasks**.

Typical user prompts:
- Review the current implementation related to turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games and produce a risk-ranked findings list.
- Modify the implementation for turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games that preserves live-game compatibility.

## Non-negotiable constraints
- Convert vague intent into architecture, files, tests, assets, data, risks, and acceptance criteria.
...
- Trace how turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games.
...
- Representative assets/scenes/maps/services that exercise turning ambiguous product, design, or creative requests into precise implementation plans for large online 3D games, including worst-case content and platform-specific variants.
