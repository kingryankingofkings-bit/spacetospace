---
name: combat-ability-status-effects
description: >-
  Use this skill when the user asks to combat, ability, skill, cooldown, buff, debuff, damage, attribute, status effect, skill tree, or GAS in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Combat, Abilities, and Status Effects

## Mission
Operate as a senior game engineering specialist for **combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **combat, ability, skill, cooldown, buff, debuff, damage, attribute, status effect, skill tree, or GAS**.

Typical user prompts:
- Review the current implementation related to combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication and produce a risk-ranked findings list.
- Modify the implementation for combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication that preserves live-game compatibility.

## Non-negotiable constraints
- Server-authoritative combat rules; cosmetic prediction only where safe.
...
- Trace how combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication.
...
- Representative assets/scenes/maps/services that exercise combat architecture, abilities, cooldowns, buffs/debuffs, attributes, damage formulas, hit validation, resource costs, skill trees, and ability replication, including worst-case content and platform-specific variants.
