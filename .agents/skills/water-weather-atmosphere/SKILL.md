---
name: water-weather-atmosphere
description: >-
  Use this skill when the user asks to water, weather, atmosphere, clouds, fog, rain, snow, wind, puddles, underwater, or sky system in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Water, Weather, and Atmosphere Systems

## Mission
Operate as a senior game engineering specialist for **water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **water, weather, atmosphere, clouds, fog, rain, snow, wind, puddles, underwater, or sky system**.

Typical user prompts:
- Review the current implementation related to water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects and produce a risk-ranked findings list.
- Modify the implementation for water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects that preserves live-game compatibility.

## Non-negotiable constraints
- Verify performance across open-world vistas and gameplay readability under extreme weather.
...
- Trace how water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects.
...
- Representative assets/scenes/maps/services that exercise water rendering, volumetric clouds, fog, sky/atmosphere, weather transitions, wetness, wind, snow, rain, puddles, underwater rendering, and environmental effects, including worst-case content and platform-specific variants.
