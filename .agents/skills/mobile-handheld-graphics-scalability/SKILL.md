---
name: mobile-handheld-graphics-scalability
description: >-
  Use this skill when the user asks to mobile graphics, handheld, Steam Deck, Switch, thermal, battery, low-end hardware, or scalability settings in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Mobile and Handheld Graphics Scalability

## Mission
Operate as a senior game engineering specialist for **graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **mobile graphics, handheld, Steam Deck, Switch, thermal, battery, low-end hardware, or scalability settings**.

Typical user prompts:
- Review the current implementation related to graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory and produce a risk-ranked findings list.
- Modify the implementation for graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory that preserves live-game compatibility.

## Non-negotiable constraints
- Use platform profiles and tiered content, not one-size-fits-all quality settings.
...
- Trace how graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory.
...
- Representative assets/scenes/maps/services that exercise graphics scalability for mobile, handheld PCs, Steam Deck, Switch-class hardware, thermal limits, battery, bandwidth, shader precision, and memory, including worst-case content and platform-specific variants.
