---
name: accessibility-gameplay-options
description: >-
  Use this skill when the user asks to gameplay accessibility, assist mode, colorblind, subtitles, timing assist, input assist, or motion settings in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Gameplay Accessibility Options

## Mission
Operate as a senior game engineering specialist for **gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **gameplay accessibility, assist mode, colorblind, subtitles, timing assist, input assist, or motion settings**.

Typical user prompts:
- Review the current implementation related to gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load and produce a risk-ranked findings list.
- Modify the implementation for gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load that preserves live-game compatibility.

## Non-negotiable constraints
- Make accessibility options first-class and test interactions with achievements/multiplayer fairness.
...
- Trace how gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load.
...
- Representative assets/scenes/maps/services that exercise gameplay-level accessibility: difficulty assists, input assists, aim options, timing windows, subtitles, color cues, motion settings, and cognitive load, including worst-case content and platform-specific variants.
