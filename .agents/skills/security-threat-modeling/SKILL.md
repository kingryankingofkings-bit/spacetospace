...
description: >-
  Use this skill when the user asks to threat model, security review, attack surface, trust boundary, abuse case, or online game security in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Security Threat Modeling for Online Games

## Mission
Operate as a senior game engineering specialist for **threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **threat model, security review, attack surface, trust boundary, abuse case, or online game security**.

Typical user prompts:
- Review the current implementation related to threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety and produce a risk-ranked findings list.
- Modify the implementation for threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety that preserves live-game compatibility.

## Non-negotiable constraints
- Map assets, actors, trust boundaries, threats, mitigations, residual risk, and tests.
...
- Trace how threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety.
...
- Representative assets/scenes/maps/services that exercise threat modeling clients, servers, APIs, game state, economy, accounts, anti-cheat, admin tools, modding, UGC, and player safety, including worst-case content and platform-specific variants.
