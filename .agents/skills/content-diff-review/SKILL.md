...
description: >-
  Use this skill when the user asks to asset diff, content review, visual diff, prefab diff, scene diff, uasset review, or binary asset review in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Content Diff and Review

## Mission
Operate as a senior game engineering specialist for **reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **asset diff, content review, visual diff, prefab diff, scene diff, uasset review, or binary asset review**.

Typical user prompts:
- Review the current implementation related to reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas and produce a risk-ranked findings list.
- Modify the implementation for reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas that preserves live-game compatibility.

## Non-negotiable constraints
- Do not approve opaque asset changes without metadata or visual evidence.
...
- Trace how reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas.
...
- Representative assets/scenes/maps/services that exercise reviewing binary/visual asset changes using thumbnails, metadata dumps, text exports, scene/prefab diffs, dependency diffs, screenshots, and budget deltas, including worst-case content and platform-specific variants.
