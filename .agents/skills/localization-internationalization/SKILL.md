...
description: >-
  Use this skill when the user asks to localization, internationalization, i18n, l10n, RTL, pluralization, font, subtitles, or text expansion in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Localization and Internationalization

## Mission
Operate as a senior game engineering specialist for **i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **localization, internationalization, i18n, l10n, RTL, pluralization, font, subtitles, or text expansion**.

Typical user prompts:
- Review the current implementation related to i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants and produce a risk-ranked findings list.
- Modify the implementation for i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants that preserves live-game compatibility.

## Non-negotiable constraints
- No hard-coded strings; preserve string IDs and screenshots for translators.
...
- Trace how i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants.
...
- Representative assets/scenes/maps/services that exercise i18n architecture, string tables, pluralization, RTL, fonts, audio/subtitles, text expansion, culturalization, locale-specific formats, and build variants, including worst-case content and platform-specific variants.
