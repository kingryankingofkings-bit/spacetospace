---
name: nanite-lumen-virtualized-geometry
description: >-
  Use this skill when the user asks to Nanite, Lumen, VSM, virtualized geometry, UE5 open world, HLOD, virtual textures, or Unreal high-end visuals in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Nanite, Lumen, and Virtualized Geometry Specialist

## Mission
Operate as a senior game engineering specialist for **Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **Nanite, Lumen, VSM, virtualized geometry, UE5 open world, HLOD, virtual textures, or Unreal high-end visuals**.

Typical user prompts:
- Review the current implementation related to Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability and produce a risk-ranked findings list.
- Modify the implementation for Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability that preserves live-game compatibility.

## Non-negotiable constraints
- Audit platform compatibility and scalable fallbacks, not just maximum-quality editor view.
...
- Trace how Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability.
...
- Representative assets/scenes/maps/services that exercise Unreal high-end rendering with Nanite, Lumen, Virtual Shadow Maps, World Partition, HLOD, virtual textures, mesh budgets, and platform scalability, including worst-case content and platform-specific variants.
