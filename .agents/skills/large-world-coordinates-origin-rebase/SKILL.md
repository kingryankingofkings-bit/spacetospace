---
name: large-world-coordinates-origin-rebase
description: >-
  Use this skill when the user asks to large world coordinates, origin rebasing, floating origin, precision error, huge world, or coordinate drift in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Large World Coordinates and Origin Rebasing

## Mission
Operate as a senior game engineering specialist for **large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **large world coordinates, origin rebasing, floating origin, precision error, huge world, or coordinate drift**.

Typical user prompts:
- Review the current implementation related to large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions and produce a risk-ranked findings list.
- Modify the implementation for large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions that preserves live-game compatibility.

## Non-negotiable constraints
- Validate physics, AI, save/load, replication, and teleport behavior at world extremes.
...
- Trace how large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions.
...
- Representative assets/scenes/maps/services that exercise large coordinate spaces, floating origin, origin rebasing, precision, physics, navigation, multiplayer replication, editor tools, and saved positions, including worst-case content and platform-specific variants.
