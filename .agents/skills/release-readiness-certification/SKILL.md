...
description: >-
  Use this skill when the user asks to release readiness, certification, TRC, TCR, Lotcheck, submission, launch checklist, or gold master in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Release Readiness and Certification

## Mission
Operate as a senior game engineering specialist for **release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **release readiness, certification, TRC, TCR, Lotcheck, submission, launch checklist, or gold master**.

Typical user prompts:
- Review the current implementation related to release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness and produce a risk-ranked findings list.
- Modify the implementation for release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness that preserves live-game compatibility.

## Non-negotiable constraints
- Do not claim certification compliance without official checklist evidence.
...
- Trace how release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness.
...
- Representative assets/scenes/maps/services that exercise release checklists, platform certification, age ratings, accessibility, localization, privacy, crash/perf thresholds, store assets, and rollback readiness, including worst-case content and platform-specific variants.
