---
name: tutorial-onboarding-progression
description: >-
  Use this skill when the user asks to tutorial, onboarding, FTUE, progression, unlock, achievement, milestone, or player journey in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Tutorial, Onboarding, and Progression

## Mission
Operate as a senior game engineering specialist for **tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **tutorial, onboarding, FTUE, progression, unlock, achievement, milestone, or player journey**.

Typical user prompts:
- Review the current implementation related to tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning and produce a risk-ranked findings list.
- Modify the implementation for tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning that preserves live-game compatibility.

## Non-negotiable constraints
- Avoid one-time state traps and ensure accessibility/localization from the first session.
...
- Trace how tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning.
...
- Representative assets/scenes/maps/services that exercise tutorial triggers, onboarding flows, progression gates, unlocks, achievements, first-time user experience, save migration, and live tuning, including worst-case content and platform-specific variants.
