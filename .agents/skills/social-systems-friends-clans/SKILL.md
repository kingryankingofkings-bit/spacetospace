---
name: social-systems-friends-clans
description: >-
  Use this skill when the user asks to friends, guild, clan, social, party invite, presence, membership, or roster in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Social Systems, Friends, Guilds, and Clans

## Mission
Operate as a senior game engineering specialist for **friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **friends, guild, clan, social, party invite, presence, membership, or roster**.

Typical user prompts:
- Review the current implementation related to friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity and produce a risk-ranked findings list.
- Modify the implementation for friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity that preserves live-game compatibility.

## Non-negotiable constraints
- Validate privacy, moderation, permissions, rate limits, and cross-platform account linking.
...
- Trace how friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity.
...
- Representative assets/scenes/maps/services that exercise friends, guilds/clans, parties, invites, presence, social graphs, permissions, membership roles, moderation, and crossplay identity, including worst-case content and platform-specific variants.
