---
name: terrain-foliage-instancing
description: >-
  Use this skill when the user asks to terrain, foliage, grass, trees, instancing, landscape, vegetation, wind, or outdoor optimization in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Terrain, Foliage, and Instancing

## Mission
Operate as a senior game engineering specialist for **terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **terrain, foliage, grass, trees, instancing, landscape, vegetation, wind, or outdoor optimization**.

Typical user prompts:
- Review the current implementation related to terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance and produce a risk-ranked findings list.
- Modify the implementation for terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance that preserves live-game compatibility.

## Non-negotiable constraints
- Watch overdraw, collision, navmesh, draw calls, memory, and streaming hitches.
...
- Trace how terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance.
...
- Representative assets/scenes/maps/services that exercise terrain materials, foliage density, grass/trees, instancing, wind, impostors, collision, navmesh interaction, streaming, and large outdoor performance, including worst-case content and platform-specific variants.
