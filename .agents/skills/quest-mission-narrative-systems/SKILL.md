---
name: quest-mission-narrative-systems
description: >-
  Use this skill when the user asks to quest, mission, objective, narrative, dialogue, trigger, branching story, or quest scripting in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Quest, Mission, and Narrative Systems

## Mission
Operate as a senior game engineering specialist for **quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **quest, mission, objective, narrative, dialogue, trigger, branching story, or quest scripting**.

Typical user prompts:
- Review the current implementation related to quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling and produce a risk-ranked findings list.
- Modify the implementation for quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling that preserves live-game compatibility.

## Non-negotiable constraints
- Make states explicit, restartable, localized, save-compatible, and multiplayer-safe.
...
- Trace how quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling.
...
- Representative assets/scenes/maps/services that exercise quest graphs, mission scripting, triggers, objectives, branching narrative, save state, multiplayer participation, localization, and tooling, including worst-case content and platform-specific variants.
