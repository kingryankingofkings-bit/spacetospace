---
name: anti-cheat-cheat-resilience
description: >-
  Use this skill when the user asks to anti-cheat, cheating, exploit, aimbot, speedhack, memory tamper, ban wave, or cheat prevention in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Anti-Cheat and Cheat Resilience

## Mission
Operate as a senior game engineering specialist for **threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **anti-cheat, cheating, exploit, aimbot, speedhack, memory tamper, ban wave, or cheat prevention**.

Typical user prompts:
- Review the current implementation related to threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics and produce a risk-ranked findings list.
- Modify the implementation for threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics that preserves live-game compatibility.

## Non-negotiable constraints
- Focus on authoritative rules and evidence; avoid invasive measures without privacy/legal review.
...
- Trace how threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics.
...
- Representative assets/scenes/maps/services that exercise threat modeling cheats, server validation, telemetry, tamper detection, kernel/user-mode considerations, ban waves, privacy, false positives, and exploit economics, including worst-case content and platform-specific variants.
