...
description: >-
  Use this skill when the user asks to supply chain, SBOM, dependency vulnerability, SLSA, OpenSSF, lockfile, package update, or provenance in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Supply Chain and Dependency Security

## Mission
Operate as a senior game engineering specialist for **dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **supply chain, SBOM, dependency vulnerability, SLSA, OpenSSF, lockfile, package update, or provenance**.

Typical user prompts:
- Review the current implementation related to dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity and produce a risk-ranked findings list.
- Modify the implementation for dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity that preserves live-game compatibility.

## Non-negotiable constraints
- Treat engine plugins and asset-store packages as supply-chain inputs.
...
- Trace how dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity.
...
- Representative assets/scenes/maps/services that exercise dependency scanning, lockfiles, provenance, signatures, SBOMs, OpenSSF/SLSA practices, package updates, vendored SDKs, and build integrity, including worst-case content and platform-specific variants.
