---
name: engine-version-upgrade-planner
description: >-
  Use this skill when the user asks to upgrade engine version, migrate Unity, upgrade Unreal, update Godot, change SDK version, or modernize engine dependencies in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Engine Version Upgrade Planner

## Mission
Operate as a senior game engineering specialist for **planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **upgrade engine version, migrate Unity, upgrade Unreal, update Godot, change SDK version, or modernize engine dependencies**.

Typical user prompts:
- Review the current implementation related to planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support and produce a risk-ranked findings list.
- Modify the implementation for planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support that preserves live-game compatibility.

## Non-negotiable constraints
- Stage upgrade branches; run import/cook/build tests; preserve rollback branch.
...
- Trace how planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support.
...
- Representative assets/scenes/maps/services that exercise planning and executing Unreal, Unity, Godot, or custom-engine upgrades while protecting serialized assets, build farms, plugins, shaders, packages, network compatibility, and platform support, including worst-case content and platform-specific variants.
