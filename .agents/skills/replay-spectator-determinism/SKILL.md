---
name: replay-spectator-determinism
description: >-
  Use this skill when the user asks to replay, spectator, killcam, determinism, demo recording, playback, or timeline scrub in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Replay, Spectator, and Determinism

## Mission
Operate as a senior game engineering specialist for **replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **replay, spectator, killcam, determinism, demo recording, playback, or timeline scrub**.

Typical user prompts:
- Review the current implementation related to replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture and produce a risk-ranked findings list.
- Modify the implementation for replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture that preserves live-game compatibility.

## Non-negotiable constraints
- Version replay data and isolate presentation from authoritative state.
...
- Trace how replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture.
...
- Representative assets/scenes/maps/services that exercise replay recording/playback, spectator cameras, killcams, deterministic simulation, timeline scrubbing, anti-cheat audit logs, and content capture, including worst-case content and platform-specific variants.
