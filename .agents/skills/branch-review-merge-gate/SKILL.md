---
name: branch-review-merge-gate
description: >-
  Use this skill when the user asks to review a PR, merge changes, gate a branch, prepare code review, or evaluate readiness for integration in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Branch Review and Merge Gate for Game Repos

## Mission
Operate as a senior game engineering specialist for **code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **review a PR, merge changes, gate a branch, prepare code review, or evaluate readiness for integration**.

Typical user prompts:
- Review the current implementation related to code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline and produce a risk-ranked findings list.
- Modify the implementation for code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline that preserves live-game compatibility.

## Non-negotiable constraints
- Require tests, perf evidence, screenshots, asset diff awareness, and rollback path.
...
- Trace how code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline.
...
- Representative assets/scenes/maps/services that exercise code review, asset review, content diffing, branch policy, merge gates, CI checks, performance gates, and release branch discipline, including worst-case content and platform-specific variants.
