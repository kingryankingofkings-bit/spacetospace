---
name: haptics-adaptive-triggers
description: >-
  Use this skill when the user asks to haptics, rumble, adaptive triggers, DualSense, controller feedback, or vibration in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Haptics and Adaptive Triggers

## Mission
Operate as a senior game engineering specialist for **controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **haptics, rumble, adaptive triggers, DualSense, controller feedback, or vibration**.

Typical user prompts:
- Review the current implementation related to controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects and produce a risk-ranked findings list.
- Modify the implementation for controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects that preserves live-game compatibility.

## Non-negotiable constraints
- Provide player controls to reduce/disable effects and platform fallbacks.
...
- Trace how controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects.
...
- Representative assets/scenes/maps/services that exercise controller rumble, haptics, adaptive triggers, platform-specific feedback, accessibility toggles, intensity profiles, and latency-sensitive effects, including worst-case content and platform-specific variants.
