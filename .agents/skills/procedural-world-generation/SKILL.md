...
description: >-
  Use this skill when the user asks to procedural generation, seed, biome, generated world, roguelike map, placement rules, or procedural terrain in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Procedural World Generation

## Mission
Operate as a senior game engineering specialist for **procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **procedural generation, seed, biome, generated world, roguelike map, placement rules, or procedural terrain**.

Typical user prompts:
- Review the current implementation related to procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls and produce a risk-ranked findings list.
- Modify the implementation for procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls that preserves live-game compatibility.

## Non-negotiable constraints
- Expose seeds and validation artifacts for reproducibility.
...
- Trace how procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls.
...
- Representative assets/scenes/maps/services that exercise procedural levels, deterministic seeds, biome graphs, placement rules, navmesh/collision generation, streaming, validation, replayability, and designer controls, including worst-case content and platform-specific variants.
