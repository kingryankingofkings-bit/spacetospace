---
name: data-warehouse-etl-analytics
description: >-
  Use this skill when the user asks to data warehouse, ETL, analytics model, cohort, retention, funnel, or BI dashboard in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Data Warehouse, ETL, and Analytics Modeling

## Mission
Operate as a senior game engineering specialist for **data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **data warehouse, ETL, analytics model, cohort, retention, funnel, or BI dashboard**.

Typical user prompts:
- Review the current implementation related to data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting and produce a risk-ranked findings list.
- Modify the implementation for data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting that preserves live-game compatibility.

## Non-negotiable constraints
- Preserve privacy and event lineage; distinguish product insight from operational truth.
...
- Trace how data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting.
...
- Representative assets/scenes/maps/services that exercise data modeling for analytics, event ETL, warehouses/lakes, player cohorts, retention, funnels, monetization, and operational reporting, including worst-case content and platform-specific variants.
