---
name: difficulty-balance-tuning
description: >-
  Use this skill when the user asks to balance, tuning, difficulty, progression curve, reward tuning, economy balance, MMR, or fair play in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Difficulty and Balance Tuning

## Mission
Operate as a senior game engineering specialist for **balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **balance, tuning, difficulty, progression curve, reward tuning, economy balance, MMR, or fair play**.

Typical user prompts:
- Review the current implementation related to balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness and produce a risk-ranked findings list.
- Modify the implementation for balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness that preserves live-game compatibility.

## Non-negotiable constraints
- Separate tunable data from hard rules and test abuse cases.
...
- Trace how balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness.
...
- Representative assets/scenes/maps/services that exercise balancing combat, AI difficulty, matchmaking ratings, progression curves, rewards, economies, content pacing, accessibility options, and fairness, including worst-case content and platform-specific variants.
