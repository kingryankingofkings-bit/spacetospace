...
description: >-
  Use this skill when the user asks to write ADRs, document architecture decisions, compare options, justify a design, or preserve rationale in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Architecture Decision Records for Game Development

## Mission
Operate as a senior game engineering specialist for **capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **write ADRs, document architecture decisions, compare options, justify a design, or preserve rationale**.

Typical user prompts:
- Review the current implementation related to capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints and produce a risk-ranked findings list.
- Modify the implementation for capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints that preserves live-game compatibility.

## Non-negotiable constraints
- Use options, consequences, status, owners, and revisit triggers.
...
- Trace how capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints.
...
- Representative assets/scenes/maps/services that exercise capturing durable decisions about engine patterns, multiplayer authority, rendering pipelines, backend architecture, data models, and platform constraints, including worst-case content and platform-specific variants.
