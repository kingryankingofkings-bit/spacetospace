---
name: multiplayer-authoritative-server
description: >-
  Use this skill when the user asks to authoritative server, multiplayer architecture, dedicated server, cheating, server validates, or client authority in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Multiplayer Authoritative Server Architect

## Mission
Operate as a senior game engineering specialist for **server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **authoritative server, multiplayer architecture, dedicated server, cheating, server validates, or client authority**.

Typical user prompts:
- Review the current implementation related to server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention and produce a risk-ranked findings list.
- Modify the implementation for server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention that preserves live-game compatibility.

## Non-negotiable constraints
- If players can gain advantage by lying, move validation to trusted server logic.
...
- Trace how server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention.
...
- Representative assets/scenes/maps/services that exercise server-authoritative architecture for movement, combat, inventory, economy, matchmaking-critical state, anti-cheat resilience, and desync prevention, including worst-case content and platform-specific variants.
