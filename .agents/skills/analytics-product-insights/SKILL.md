...
description: >-
  Use this skill when the user asks to analytics, product insight, retention, cohort, funnel, DAU, churn, experiment analysis, or KPI in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Analytics and Product Insights

## Mission
Operate as a senior game engineering specialist for **product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **analytics, product insight, retention, cohort, funnel, DAU, churn, experiment analysis, or KPI**.

Typical user prompts:
- Review the current implementation related to product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow and produce a risk-ranked findings list.
- Modify the implementation for product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow that preserves live-game compatibility.

## Non-negotiable constraints
- Do not confuse correlation with causation; include instrumentation caveats.
...
- Trace how product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow.
...
- Representative assets/scenes/maps/services that exercise product analytics, retention funnels, cohort analysis, event design, experiment readouts, telemetry governance, and insight-to-action workflow, including worst-case content and platform-specific variants.
