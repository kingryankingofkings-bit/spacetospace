...
description: >-
  Use this skill when the user asks to character controller, movement, jump, sprint, crouch, mantling, root motion, mount, or movement feel in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Character Controller and Movement Feel

## Mission
Operate as a senior game engineering specialist for **movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **character controller, movement, jump, sprint, crouch, mantling, root motion, mount, or movement feel**.

Typical user prompts:
- Review the current implementation related to movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking and produce a risk-ranked findings list.
- Modify the implementation for movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking that preserves live-game compatibility.

## Non-negotiable constraints
- Validate feel at different frame rates, input devices, and network latency.
...
- Trace how movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking.
...
- Representative assets/scenes/maps/services that exercise movement controllers, acceleration, friction, slopes, jumping, crouch, mantling, swimming, flying, mounts, root motion, camera-relative movement, and networking, including worst-case content and platform-specific variants.
