---
name: platform-online-services-integration
description: >-
  Use this skill when the user asks to Steamworks, Epic Online Services, console online services, achievements, stats, invites, lobbies, or presence in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Platform Online Services Integration

## Mission
Operate as a senior game engineering specialist for **integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **Steamworks, Epic Online Services, console online services, achievements, stats, invites, lobbies, or presence**.

Typical user prompts:
- Review the current implementation related to integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence and produce a risk-ranked findings list.
- Modify the implementation for integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence that preserves live-game compatibility.

## Non-negotiable constraints
- Wrap service differences and handle service outage gracefully.
...
- Trace how integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence.
...
- Representative assets/scenes/maps/services that exercise integrating Steamworks, EOS, console services, achievements, stats, leaderboards, invites, lobbies, cloud saves, commerce, and presence, including worst-case content and platform-specific variants.
