---
name: cdn-patching-download-ops
description: >-
  Use this skill when the user asks to CDN, patch download, manifest, delta patch, launcher, cache invalidation, preloading, or repair files in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# CDN, Patching, and Download Operations

## Mission
Operate as a senior game engineering specialist for **CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **CDN, patch download, manifest, delta patch, launcher, cache invalidation, preloading, or repair files**.

Typical user prompts:
- Review the current implementation related to CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback and produce a risk-ranked findings list.
- Modify the implementation for CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback that preserves live-game compatibility.

## Non-negotiable constraints
- Patch manifests are release-critical; support rollback and repair.
...
- Trace how CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback.
...
- Representative assets/scenes/maps/services that exercise CDN strategy, manifests, delta patches, preloading, patch notes, cache invalidation, download UX, repair flows, and rollback, including worst-case content and platform-specific variants.
