---
name: voice-chat-moderation-safety
description: >-
  Use this skill when the user asks to voice chat, text chat, proximity chat, moderation, report player, mute, block, or toxicity in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Voice Chat, Text Chat, and Player Safety

## Mission
Operate as a senior game engineering specialist for **voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **voice chat, text chat, proximity chat, moderation, report player, mute, block, or toxicity**.

Typical user prompts:
- Review the current implementation related to voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy and produce a risk-ranked findings list.
- Modify the implementation for voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy that preserves live-game compatibility.

## Non-negotiable constraints
- Safety controls must be reachable, persistent, and auditable.
...
- Trace how voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy.
...
- Representative assets/scenes/maps/services that exercise voice chat, text chat, proximity chat, moderation, reporting, blocking, mute, transcription, safety settings, harassment prevention, and privacy, including worst-case content and platform-specific variants.
