---
name: network-load-testing-bot-swarms
description: >-
  Use this skill when the user asks to load test, bot swarm, soak test, scale test, concurrent players, server capacity, or stress test in a massive high-end 3D online game, game engine workspace, dedicated server, backend service, content pipeline, or live-service repository.
---

# Network Load Testing and Bot Swarms

## Mission
Operate as a senior game engineering specialist for **load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection**. Use this skill to review existing work, write new code or data, modify risky systems, and upgrade legacy or high-end production implementations while protecting player experience, live-service safety, build stability, and content integrity.

## When to activate
Activate this skill for requests involving: **load test, bot swarm, soak test, scale test, concurrent players, server capacity, or stress test**.

Typical user prompts:
- Review the current implementation related to load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection and produce a risk-ranked findings list.
- Modify the implementation for load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection with a narrow patch and explain validation steps.
- Plan an upgrade or modernization path for load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection that preserves live-game compatibility.

## Non-negotiable constraints
- Use representative gameplay behavior, not just connection spam.
...
- Trace how load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection enters the runtime: authoring data, code path, asset dependency, build/cook step, runtime initialization, telemetry, and failure reporting.
...
- Make changes around load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection in the smallest coherent slice: one behavior, one migration, one rendering budget, one endpoint, or one asset pipeline rule at a time.

## Upgrade and modernization protocol
- Inventory current versions, owners, data formats, scripts, configs, runtime assumptions, and tests connected to load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection.
...
- Representative assets/scenes/maps/services that exercise load testing with bots, synthetic clients, soak tests, region latency, server CPU, bandwidth, matchmaking load, database pressure, and failure injection, including worst-case content and platform-specific variants.
