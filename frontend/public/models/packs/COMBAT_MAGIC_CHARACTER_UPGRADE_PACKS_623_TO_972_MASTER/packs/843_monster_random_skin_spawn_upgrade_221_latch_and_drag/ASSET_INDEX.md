# Monster Random Skin Spawn Upgrade 221 - Latch And Drag
...
Support NPC: `Brunt the Bastion`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Latch & Drag
...
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Ethereal Cloak
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Brunt the Bastion
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Subway-Rat
