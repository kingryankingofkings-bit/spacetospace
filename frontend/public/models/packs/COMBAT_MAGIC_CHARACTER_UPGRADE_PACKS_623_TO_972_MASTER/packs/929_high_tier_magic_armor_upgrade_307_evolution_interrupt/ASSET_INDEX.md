# High-Tier Magic Armor Upgrade 307 - Evolution Interrupt

Pack number: **929**
Family: `high_tier_armor`
Theme: `glacial`
Monster: `The Venom-Spitter`
Boss: `The Ascendant Colossus`
Player Class: `The Resonant`
Support NPC: `The Fragmented Core`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Evolution Interrupt
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Venom-Spitter
...
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Geode-Snail
