# Support NPC Assist Upgrade 055 - The Bass Drop

Pack number: **677**
Family: `support_npc_assists`
Theme: `glacial`
Monster: `The Iron-Jaw Hound`
Boss: `The Ascendant Colossus`
Player Class: `The Sylvan Warden`
Support NPC: `The Fragmented Core`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — The Bass Drop
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Iron-Jaw Hound
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Maestro's Tuning-Fork Focus
...
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Hover-Moth
