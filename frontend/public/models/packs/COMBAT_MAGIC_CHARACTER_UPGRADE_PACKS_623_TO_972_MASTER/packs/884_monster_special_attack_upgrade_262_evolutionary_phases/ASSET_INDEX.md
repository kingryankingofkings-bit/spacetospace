# Monster Special Attack Upgrade 262 - Evolutionary Phases
...
Support NPC: `Vex the Scavenger`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Evolutionary Phases
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — Nexus Warden
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Dawnforge Class Weapon Calibration Kit
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Sevenfold Helm
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Vex the Scavenger
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Plasma-Wisp
