# Monster Random Skin Spawn Upgrade 091 - Linear Swarm
...
## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Linear Swarm
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Grid-Rushers
