# Support NPC Assist Upgrade 315 - Thermal Detonation
...
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Eclipse Sigil Blade
...
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Trench-Crab
