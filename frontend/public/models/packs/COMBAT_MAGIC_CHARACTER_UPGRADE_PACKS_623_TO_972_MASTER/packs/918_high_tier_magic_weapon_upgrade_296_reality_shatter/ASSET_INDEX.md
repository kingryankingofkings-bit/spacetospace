# High-Tier Magic Weapon Upgrade 296 - Reality Shatter

Pack number: **918**
Family: `high_tier_weapons`
Theme: `storm`
Monster: `The Scrap-Stalker`
Boss: `The Astral Sovereign`
Player Class: `The Scrap-Tek`
Support NPC: `Lyra the Void-Touched`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Reality Shatter
...
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Digitize-Weave Suit
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Lyra the Void-Touched
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Lantern-Guppy
