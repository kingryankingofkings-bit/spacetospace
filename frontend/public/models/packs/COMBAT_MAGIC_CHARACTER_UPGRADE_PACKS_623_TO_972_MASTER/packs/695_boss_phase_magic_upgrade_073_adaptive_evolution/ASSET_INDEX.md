# Boss Phase Magic Upgrade 073 - Adaptive Evolution
...
Player Class: `The Orbital Striker`
...
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Colossus Heartplate
...
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Pressure-Squid
