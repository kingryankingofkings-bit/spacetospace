# Monster Special Attack Upgrade 212 - Zero G Combos
...
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Null-Splinter Phaseblade
...
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Dew-Drop Beetle
