# High-Tier Magic Armor Upgrade 067 - Rooting Strike
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Zephyr the Pilot
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Glass-Turtle
