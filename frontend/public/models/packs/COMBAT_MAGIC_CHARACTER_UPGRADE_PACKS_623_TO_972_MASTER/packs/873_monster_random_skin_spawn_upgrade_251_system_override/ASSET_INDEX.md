# Monster Random Skin Spawn Upgrade 251 - System Override
...
Support NPC: `The Fragmented Core`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — System Override
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Gnarl-Maws
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Sevenfold Class Weapon Calibration Kit
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — The Fragmented Core
