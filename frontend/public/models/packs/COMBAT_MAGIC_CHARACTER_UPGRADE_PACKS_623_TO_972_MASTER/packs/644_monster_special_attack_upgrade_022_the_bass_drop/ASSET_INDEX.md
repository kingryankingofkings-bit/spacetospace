# Monster Special Attack Upgrade 022 - The Bass Drop

Pack number: **644**
Family: `monster_special_attacks`
Theme: `astral`
Monster: `The Scrap-Phalanx`
Boss: `The Data-Forged Evolvarch`
Player Class: `The Phantom-Shift`
Support NPC: `The Grand Archivist`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — The Bass Drop
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Scrap-Phalanx
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Dawnforge Class Weapon Calibration Kit
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Heat-Resistant Plating
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — The Grand Archivist
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Lunar-Moth
