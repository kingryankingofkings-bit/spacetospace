# High-Tier Magic Weapon Upgrade 186 - Projectile Reversal
...
Support NPC: `Cipher the Deviant`
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Cipher the Deviant
