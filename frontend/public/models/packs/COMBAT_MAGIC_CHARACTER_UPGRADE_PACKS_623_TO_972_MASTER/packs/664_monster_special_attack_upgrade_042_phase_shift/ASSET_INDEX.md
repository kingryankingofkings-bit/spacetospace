# Monster Special Attack Upgrade 042 - Phase Shift
...
Support NPC: `Commander Solis`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Phase Shift
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Commander Solis
