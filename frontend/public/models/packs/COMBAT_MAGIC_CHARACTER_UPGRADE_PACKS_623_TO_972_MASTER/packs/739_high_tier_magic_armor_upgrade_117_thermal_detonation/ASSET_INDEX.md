# High-Tier Magic Armor Upgrade 117 - Thermal Detonation
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Flora the Druid
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Cable-Snake
