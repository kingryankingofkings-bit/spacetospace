# Monster Random Skin Spawn Upgrade 181 - Orbital Deflection
...
Support NPC: `Ignis the Burner`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Orbital Deflection
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Aegis Carapace
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Astral Sovereign Gravity Crown
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Hollow-Moon Bracers
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Ignis the Burner
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Meteor-Pup
