# Monster Random Skin Spawn Upgrade 161 - Deep Siphon
...
Support NPC: `Red-Pen Quinn`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Deep Siphon
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Red-Pen Quinn
