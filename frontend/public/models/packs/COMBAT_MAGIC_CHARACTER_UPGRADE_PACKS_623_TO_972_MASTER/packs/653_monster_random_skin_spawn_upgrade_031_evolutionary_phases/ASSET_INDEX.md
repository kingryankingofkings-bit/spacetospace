# Monster Random Skin Spawn Upgrade 031 - Evolutionary Phases
...
Support NPC: `Boomer Dax`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Evolutionary Phases
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Siphon-Ticks
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Astral Sovereign Gravity Crown
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Heavy Space-Marine Suit
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Boomer Dax
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Gutter-Bot
