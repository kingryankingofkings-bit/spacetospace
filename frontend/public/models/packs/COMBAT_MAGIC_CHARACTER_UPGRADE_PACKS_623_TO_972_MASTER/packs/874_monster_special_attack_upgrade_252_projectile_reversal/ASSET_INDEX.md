# Monster Special Attack Upgrade 252 - Projectile Reversal
...
Support NPC: `Jace the Glitch`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Projectile Reversal
...
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Geometric Processing Suit
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Jace the Glitch
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Bark-Pug
