# Player Class Special Magic Upgrade 204 - Forced Evolution

Pack number: **826**
Family: `player_class_magic`
Theme: `neon`
Monster: `The Scrap-Phalanx`
Boss: `The Ivory Behemoth`
Player Class: `The Apex Mutator`
Support NPC: `Beastmaster Thorne`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Forced Evolution
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Scrap-Phalanx
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Evolvarch Recursive Core
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Beastmaster Thorne
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Dust-Fox
