# High-Tier Magic Weapon Upgrade 076 - Evolution Interrupt
...
Support NPC: `Kaelia of the Roots`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Evolution Interrupt
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Void Anomaly
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Astral Sovereign Gravity Crown
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Exosphere Flight Suit
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Kaelia of the Roots
