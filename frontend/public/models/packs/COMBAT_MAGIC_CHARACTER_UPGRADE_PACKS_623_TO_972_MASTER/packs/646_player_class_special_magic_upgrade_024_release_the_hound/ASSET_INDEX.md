# Player Class Special Magic Upgrade 024 - Release The Hound
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — The Iron Warden
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Echo-Bat
