# Monster Random Skin Spawn Upgrade 231 - Combo Locked Shielding

Pack number: **853**
Family: `monster_skin_randomizer`
Theme: `crystal`
Monster: `The Scrap-Stalker`
Boss: `The Ivory Behemoth`
Player Class: `The Protocol Weaver`
Support NPC: `Silas the Houndmaster`

## GLB Upgrade Modules
- `glb_upgrades/01_special_attack_vfx.glb` — special_attack_vfx — Combo-Locked Shielding
- `glb_upgrades/02_random_skin_projector.glb` — random_skin_projector — The Scrap-Stalker
- `glb_upgrades/03_magic_weapon_upgrade.glb` — magic_weapon_upgrade — Chimeric Adaptation Blade
- `glb_upgrades/04_magic_armor_upgrade.glb` — magic_armor_upgrade — Dawnforge Bracers
...
- `glb_upgrades/07_support_npc_aura.glb` — support_npc_aura — Silas the Houndmaster
- `glb_upgrades/08_pet_companion_proc.glb` — pet_companion_proc — Tuning-Pup
